...
public class E6_TargetingState : BehaviourState
{
    Enemy6 enemy;
    ...
    public E6_TargetingState(Entity entity, FiniteStateMachine stateMachine, AnimationManager animManger, D_BehaviourState stateDatar, Enemy6 enemy, string animationName, string animationBoolName) : base(entity, stateMachine, animManger, stateDatar, animationName, animationBoolName)
    {
        this.enemy = enemy;
    ...
    public override void LogicUpdate()
    {
        ...
        if (attackRange && timer >= stateData.timeBetweenAttacks)
        {
            ...
            {
                stateMachine.ChangeState(enemy.meeleAttackState3);
            }
        }
        else if (!agroRange)
        {
