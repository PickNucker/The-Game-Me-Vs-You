...
public class PlayerDodgeBackState : PlayerGroundedState
{
    public PlayerDodgeBackState(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation("Dodge_Back", true, true);
