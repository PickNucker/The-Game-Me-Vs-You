...
public class P_Attack_4_7_G : PlayerAbilityState
{
    public P_Attack_4_7_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[3].animationName[3], false, true);
