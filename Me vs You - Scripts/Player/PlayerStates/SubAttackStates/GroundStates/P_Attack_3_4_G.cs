...
public class P_Attack_3_4_G : PlayerAbilityState
{
    public P_Attack_3_4_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[2].animationName[2], false, true);
    ...
    public override void LogicUpdate()
    {
        ...
        {
            stateMachine.ChangeState(player.Attack_3_5_G);
        }
    }
}
