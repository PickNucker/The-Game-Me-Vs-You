...
public class P_Attack_2_7_G : PlayerAbilityState
{
    public P_Attack_2_7_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[1].animationName[5], false, true);
    ...
    public override void LogicUpdate()
    {
        ...
        {
            stateMachine.ChangeState(player.Attack_2_8_G);
        }
    }
}
