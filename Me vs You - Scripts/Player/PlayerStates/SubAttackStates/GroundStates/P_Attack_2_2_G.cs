...
public class P_Attack_2_2_G : PlayerAbilityState
{
    public P_Attack_2_2_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[1].animationName[0], false, true);
    ...
    public override void LogicUpdate()
    {
        ...
        player.IngameUi.ChangeText("", "Attack", "Dash-Attack", "");
       ...
       // }
        ...
        {
            stateMachine.ChangeState(player.Attack_2_3_G);
        }
