...
public class P_Attack_4_4_G : PlayerAbilityState
{
    public P_Attack_4_4_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[3].animationName[1], false, true);
