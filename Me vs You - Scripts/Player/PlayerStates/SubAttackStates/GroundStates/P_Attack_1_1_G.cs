...
public class P_Attack_1_1_G : PlayerAbilityState
{
    public P_Attack_1_1_G(Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.AnimManager.PlayTargetAnimation(player.Input.combo[0].animationName[0], false, true);
    ...
    public override void LogicUpdate()
    {
        ...
        player.IngameUi.ChangeText("Attack", "Attack 3", "Attack 2", "");
        ...
        {
            stateMachine.ChangeState(player.Attack_2_2_G);
        }

        if (player.canCombo && player.isGrounded && player.Input.KreisPressed)
        {
            stateMachine.ChangeState(player.Attack_3_2_G);
        }
    }
